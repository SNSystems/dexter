...
// DexExpectWatchValue('start',  '0',                     from_line=10, to_line=17)
// DexExpectWatchValue('count',  '4',                     from_line=10, to_line=17)
// DexExpectWatchValue('result', '0', '1', '3', '6',      from_line=10, to_line=17)
// DexExpectWatchValue('ix',     '0', '1', '2', '3', '4', from_line=10, to_line=17)
